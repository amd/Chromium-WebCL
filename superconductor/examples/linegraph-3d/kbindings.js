...
this._gen_setKernelArguments = function(kernel) {
	kernel.setArg(0, new Int32Array([0]));	// start_idx (default to 0)
	kernel.setArg(1, new Int32Array([this.tree_size]));
...
this._gen_allocateHostProxies = function (treeSize) {
	...
	this.fld_generator_childs_rotation_init = this.int_buffer_1.subarray(treeSize * 79, (treeSize * 79) + treeSize);
	this.fld_generator_childs_rotation_last = this.int_buffer_1.subarray(treeSize * 80, (treeSize * 80) + treeSize);
	...
	this.fld_generator_childs_xoffset_init = this.int_buffer_1.subarray(treeSize * 75, (treeSize * 75) + treeSize);
	this.fld_generator_childs_xoffset_last = this.int_buffer_1.subarray(treeSize * 76, (treeSize * 76) + treeSize);
	...
	this.fld_second_childs_rotation_init = this.int_buffer_1.subarray(treeSize * 54, (treeSize * 54) + treeSize);
	this.fld_second_childs_rotation_last = this.int_buffer_1.subarray(treeSize * 55, (treeSize * 55) + treeSize);
	...
	this.fld_second_childs_xoffset_init = this.int_buffer_1.subarray(treeSize * 50, (treeSize * 50) + treeSize);
	this.fld_second_childs_xoffset_last = this.int_buffer_1.subarray(treeSize * 51, (treeSize * 51) + treeSize);
