...
void* __stdcall svGetTextureUltimatePointer(GLuint tex)
{
	gl::Context *context = gl::getNonLostContext();
	return context->getTextureUltimatePointer(tex);
}
void* __stdcall svGetBufferUltimatePointer(GLuint tex)
{
	gl::Context *context = gl::getNonLostContext();
...
cl_mem __stdcall sv_clCreateFromGLTexture (	cl_context context,
 	...
 	cl_int *errcode_ret) {
	gl::Context *glc = gl::getNonLostContext();
	return glc->clCreateFromGLTexture(context, flags, texture_target, miplevel, texture, errcode_ret);
}
...
cl_mem __stdcall sv_clCreateFromGLRenderbuffer (	cl_context context,
 	...
 	cl_int * errcode_ret) {
	gl::Context *glc = gl::getNonLostContext();
	return glc->clCreateFromGLRenderbuffer(context, flags, renderbuffer, errcode_ret);
}
...
cl_int __stdcall sv_clEnqueueAcquireGLObjects (	cl_command_queue command_queue,
 	...
 	cl_event *event) {
	gl::Context *glc = gl::getNonLostContext();
	return glc->clEnqueueAcquireGLObjects(command_queue, num_objects, mem_objects, num_events_in_wait_list, event_wait_list, event);
}
...
cl_int __stdcall sv_clEnqueueReleaseGLObjects (	cl_command_queue command_queue,
 	...
 	cl_event *event) {
	gl::Context *glc = gl::getNonLostContext();
	return glc->clEnqueueReleaseGLObjects(command_queue, num_objects, mem_objects, num_events_in_wait_list, event_wait_list, event);
}
...
cl_int __stdcall sv_clGetGLObjectInfo (	cl_mem memobj,
	...
	gl::Context *glc = gl::getNonLostContext();
	return glc->clGetGLObjectInfo(memobj, gl_object_type, gl_object_name);
}
...
cl_int __stdcall sv_clGetGLTextureInfo (	cl_mem memobj,
	...
	gl::Context *glc = gl::getNonLostContext();
	return glc->clGetGLTextureInfo(memobj, param_name, param_value_size, param_value, param_value_size_ret);
}
