...
//extern "C"
SIMD_ALIGNED(const int16 kCoefficientsRgbY[768][4] = {0});
//extern "C"
SIMD_ALIGNED(const int16 kCoefficientsBgraY[768][4] = {0});
//extern "C"
SIMD_ALIGNED(const int16 kCoefficientsAbgrY[768][4] = {0});
