...
# OpenCL
VP9_COMMON_SRCS-yes += common/inter_ocl/opencl/clew.c # on Win32
VP9_COMMON_SRCS-yes += common/inter_ocl/opencl/clew.h # on Win32
VP9_COMMON_SRCS-yes += common/inter_ocl/opencl/ocl_wrapper.c
VP9_COMMON_SRCS-yes += common/inter_ocl/opencl/ocl_wrapper.h


VP9_COMMON_SRCS-yes += common/inter_ocl/vp9_convolve_ocl_c.c
VP9_COMMON_SRCS-yes += common/inter_ocl/vp9_convolve_ocl_c.h
VP9_COMMON_SRCS-yes += common/inter_ocl/vp9_inter_ocl_init.c
VP9_COMMON_SRCS-yes += common/inter_ocl/vp9_inter_ocl_init.h
VP9_COMMON_SRCS-yes += common/inter_ocl/vp9_inter_ocl_param.c
