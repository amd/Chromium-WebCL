...
int clewInit(const char* path)
{
    ...
    CLEW_CHECK_FUNCTION(__clewGetExtensionFunctionAddressForPlatform = (PFNCLGETEXTENSIONFUNCTIONADDRESSFORPLATFORM)CLCC_DYNLIB_IMPORT(module, "clGetExtensionFunctionAddressForPlatform"));
