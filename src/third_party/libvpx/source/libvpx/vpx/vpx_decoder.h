...
#define VPX_CODEC_USE_FRAME_THREADING   0x80000 /**< Enable frame-based
  ...
  vpx_codec_err_t vpx_codec_dec_init_ver_ex(vpx_codec_ctx_t_ex    *ctx,
...
#define vpx_codec_dec_init_ex(ctx, iface, cfg, flags, d3ddev) \
  vpx_codec_dec_init_ver_ex(ctx, iface, cfg, flags, VPX_DECODER_ABI_VERSION,d3ddev)
  ...
  vpx_codec_err_t vpx_codec_peek_stream_info(vpx_codec_iface_t       *iface,
   ...
   vpx_codec_err_t vpx_codec_peek_stream_info_ex(vpx_codec_iface_t_ex       *iface,
                                             const uint8_t           *data,
                                             unsigned int             data_sz,
                                             vpx_codec_stream_info_t *si);
  ...
  vpx_codec_err_t vpx_codec_decode_ex(vpx_codec_ctx_t_ex    *ctx,
                                   const uint8_t        *data,
                                   unsigned int            data_sz,
                                   void               *user_priv,
                                   long                deadline,
  ...
  vpx_image_t *vpx_codec_get_frame_ex(vpx_codec_ctx_t_ex  *ctx,
                                   vpx_codec_iter_t *iter);
 ...
 vpx_codec_err_t vpx_codec_register_put_frame_cb_ex(vpx_codec_ctx_t_ex             *ctx,
                                                  vpx_codec_put_frame_cb_fn_t  cb,
                                                  void                        *user_priv);
  ...
  vpx_codec_err_t vpx_codec_register_put_slice_cb_ex(vpx_codec_ctx_t_ex             *ctx,
                                                  vpx_codec_put_slice_cb_fn_t  cb,
                                                  void                        *user_priv);
  ...
  vpx_codec_err_t vpx_codec_set_frame_buffers_ex(
      vpx_codec_ctx_t_ex *ctx,
      vpx_codec_frame_buffer_t *fb_list, int fb_count,
      vpx_realloc_frame_buffer_cb_fn_t cb, void *user_priv);
