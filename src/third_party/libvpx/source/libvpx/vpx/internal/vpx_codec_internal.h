...
typedef vpx_codec_err_t(*vpx_codec_init_fn_t_ex)(vpx_codec_ctx_t_ex *ctx,
                                               vpx_codec_priv_enc_mr_cfg_t *data, void *id3d9_device);
...
typedef vpx_codec_err_t (*vpx_codec_decode_fn_t_ex)(vpx_codec_alg_priv_t  *ctx,
                                                 const uint8_t         *data,
                                                 unsigned int     data_sz,
                                                 void        *user_priv,
                                                 long         deadline,
...
typedef vpx_codec_err_t (*vpx_codec_get_mmap_fn_t_ex)(const vpx_codec_ctx_t_ex      *ctx,
                                                   vpx_codec_mmap_t           *mmap,
                                                   vpx_codec_iter_t           *iter);
...
typedef vpx_codec_err_t (*vpx_codec_set_mmap_fn_t_ex)(vpx_codec_ctx_t_ex         *ctx,
                                                   const vpx_codec_mmap_t  *mmap);
...
struct vpx_codec_iface_ex {
  ...
  int                       abi_version; /**< Implemented ABI version */
  vpx_codec_caps_t          caps;    /**< Decoder capabilities */
  vpx_codec_init_fn_t_ex       init;    /**< \copydoc ::vpx_codec_init_fn_t */
  vpx_codec_destroy_fn_t    destroy;     /**< \copydoc ::vpx_codec_destroy_fn_t */
  vpx_codec_ctrl_fn_map_t  *ctrl_maps;   /**< \copydoc ::vpx_codec_ctrl_fn_map_t */
  vpx_codec_get_mmap_fn_t_ex   get_mmap;    /**< \copydoc ::vpx_codec_get_mmap_fn_t */
  vpx_codec_set_mmap_fn_t_ex   set_mmap;    /**< \copydoc ::vpx_codec_set_mmap_fn_t */
    struct vpx_codec_dec_iface_ex {
    vpx_codec_peek_si_fn_t    peek_si;     /**< \copydoc ::vpx_codec_peek_si_fn_t */
    vpx_codec_get_si_fn_t     get_si;      /**< \copydoc ::vpx_codec_get_si_fn_t */
    vpx_codec_decode_fn_t_ex     decode;      /**< \copydoc ::vpx_codec_decode_fn_t */
    vpx_codec_get_frame_fn_t  get_frame;   /**< \copydoc ::vpx_codec_get_frame_fn_t */
    vpx_codec_set_frame_buffers_fn_t set_fb; /**< \copydoc ::vpx_codec_set_frame_buffers_fn_t */
  } dec;
	 VPX_CODEC_ENC enc;
...
struct vpx_codec_priv_ex {
  unsigned int                    sz;
  vpx_codec_iface_t_ex              *iface;
  struct vpx_codec_alg_priv      *alg_priv;
  const char                     *err_detail;
  vpx_codec_flags_t               init_flags;
  struct {
 ...
 */
#define CODEC_INTERFACE_EX(id)\
  vpx_codec_iface_t_ex* id(void) { return &id##_algo; }\
  vpx_codec_iface_t_ex  id##_algo
